...
const msg = {
    ...
    not_enought_tasks: {
        ...
        params: {
            caption: "Ошибка",
            text1: "По выбранной сложности недостаточно задач. Доступное количество задач:",
...
exports.L = {
    ru: {
        ...
        //lesson start page
        SPG: {
            INTRO1: "Приветствуем вас в учебнике 📘 ! В учебнике доступна теория только по открытым темам",
            INTRO2: "Удачи в чемпионате!",
            INTRO3: "В режиме челлендж нет повторения и все задачи должны быть решены с первого раза",
            INTRO4: "Постарайтесь решить задачу с первого раза, за это начисляются монеты, которые используются для открытия новых уроков",
            INTRO5: "Вы достигли лимита монет по этой главе😭, здесь вы уже их не заработаете🚫",
            INTRO6: "В режиме повторения начисляется гораздо меньше монет",
        },
        msg,
        INTERRUPT: {
            INTERRUPT_CAPTION: "Завершить",
            INTERRUPT_TEXT1: "Если досрочно завершить прохождение, \nто при повторном запуске вы будете получать \n2 монеты за каждую задачу вместо 10 монет",
            INTERRUPT_TEXT2: "Если досрочно завершить прохождение, \nто при повторном запуске вы будете получать \n1 монету за каждую задачу вместо 2 монет",
        ...
        CE: {
            ...
            error3: "Ты написал код, который выдает правильные данные, но количество строчек программы больше нужного и не использованы нужные функции или операторы",

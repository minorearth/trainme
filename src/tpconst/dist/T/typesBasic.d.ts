...
export type UnitsetModeSpecific = (typeof TSM)["champ" | "textbook" | "exam" | "default"];
export type UnitsetMode = UnitsetModeSpecific | Extract<NodeModes, "newtopic" | "addhoc" | "exam">;

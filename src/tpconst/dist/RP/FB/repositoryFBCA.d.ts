import { ChampDB, ChampuserDB, TaskDB, TasksLogDB, CourseChapterObjDB, EdgeDB, FlowDB, NodeDB, GroupArr, GroupUserDBAttrs, UserMetaDB, UsersMetaReportDB, completedChapters } from "../../T";
...
export declare const getAllCourseTasks: (courseid: string) => Promise<TaskDB[]>;

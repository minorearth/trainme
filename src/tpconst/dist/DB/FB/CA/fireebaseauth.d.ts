...
export declare const launchAuthStateChangeMonitorDB: (action: (resolved: (value: string) => void, rejected: (value: string) => void, uid: string, emailVerified: boolean) => void) => Promise<string>;
